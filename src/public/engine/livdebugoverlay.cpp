...
static int debugoverlay_AddBoxOverlay (lua_State *L) {
  debugoverlay->AddBoxOverlay(luaL_checkvector(L, 1), luaL_checkvector(L, 2), luaL_checkvector(L, 3), luaL_checkangle(L, 4), luaL_checkinteger(L, 5), luaL_checkinteger(L, 6), luaL_checkinteger(L, 7), luaL_checkinteger(L, 8), luaL_checknumber(L, 9));
  return 0;
}
...
static int debugoverlay_AddLineOverlay (lua_State *L) {
  debugoverlay->AddLineOverlay(luaL_checkvector(L, 1), luaL_checkvector(L, 2), luaL_checkinteger(L, 3), luaL_checkinteger(L, 4), luaL_checkinteger(L, 5), luaL_checkboolean(L, 6), luaL_checknumber(L, 7));
  return 0;
}

static int debugoverlay_AddLineOverlayAlpha (lua_State *L) {
  debugoverlay->AddLineOverlayAlpha(luaL_checkvector(L, 1), luaL_checkvector(L, 2), luaL_checkinteger(L, 3), luaL_checkinteger(L, 4), luaL_checkinteger(L, 5), luaL_checkinteger(L, 6), luaL_checkboolean(L, 7), luaL_checknumber(L, 8));
  return 0;
}
...
static int debugoverlay_AddSweptBoxOverlay (lua_State *L) {
  debugoverlay->AddSweptBoxOverlay(luaL_checkvector(L, 1), luaL_checkvector(L, 2), luaL_checkvector(L, 3), luaL_checkvector(L, 4), luaL_checkangle(L, 5), luaL_checkinteger(L, 6), luaL_checkinteger(L, 7), luaL_checkinteger(L, 8), luaL_checkinteger(L, 9), luaL_checknumber(L, 10));
  return 0;
}

static int debugoverlay_AddTriangleOverlay (lua_State *L) {
  debugoverlay->AddTriangleOverlay(luaL_checkvector(L, 1), luaL_checkvector(L, 2), luaL_checkvector(L, 3), luaL_checkinteger(L, 4), luaL_checkinteger(L, 5), luaL_checkinteger(L, 6), luaL_checkinteger(L, 7), luaL_checkboolean(L, 8), luaL_checknumber(L, 9));
  return 0;
}
